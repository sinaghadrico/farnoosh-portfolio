...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      { alt: "Personalised route summary on arrival in a new city", ratio: "portrait", span: "regular" },
      { alt: "Transit transfer view with clearer next-step hierarchy", ratio: "portrait", span: "regular" },
      { alt: "Place detail view with traveler-focused context", ratio: "wide", span: "full" },
    ],
    link: { label: "View on Figma", href: "https://figma.com" },
  },
  {
